...
c.execute("""INSERT INTO productos VALUES(2125, "Polera Spring", "vestuario","amarillo","9000", 2)""")
c.execute("""INSERT INTO productos VALUES(4647, "Poseidon", "lavadora","blanco","150000", 4)""")
...
c.execute("""INSERT INTO productos VALUES(2567, "BrownBook", "vestuario","cafe","19000", 2)""")
c.execute("""INSERT INTO productos VALUES(1245, "Brasil Selection", "vestuario","amarillo","20000", 1)""")
c.execute("""INSERT INTO productos VALUES(1211, "Short Run", "vestuario","negro","10000", 1)""")
c.execute("""INSERT INTO productos VALUES(1535 , "Hyperdunk", "calzado","rojo","45000", 1)""")
c.execute("""INSERT INTO productos VALUES(3212, "iPad 3", "smartphone","blanco","220000", 3)""")
c.execute("""INSERT INTO productos VALUES(2555, "Short Champion", "vestuario","blanco","20000", 2)""")
c.execute("""INSERT INTO productos VALUES(4678, "Ativ Book 9", "computacion","azul","300000", 4)""")
